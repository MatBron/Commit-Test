		...
		return this.each(function(options){
			...
			function dcssb_social(type){
				...
				switch (type) {
					...
					$button = '<div class="dcssb-btn dcssb-twitter"><a href="http://twitter.com/share" data-url="'+url+'" data-counturl="'+url+'" data-text="" class="twitter-share-button" data-count="'+btn+'" data-via="'+defaults.twitterId+'"></a></div><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>';
					break;
